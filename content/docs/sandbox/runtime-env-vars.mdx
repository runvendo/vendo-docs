...
If you need a provider key in env for a third-party SDK that won't accept the proxy URL, declare it in your tool's `vendo.yaml` `env_bootstrap` and the deploy worker will inject it.
