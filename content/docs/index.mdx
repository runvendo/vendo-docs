...
<Cards>
  <Card
    title="Python"
    description="pip install vendo-sdk — async-first, stdlib only"
  ...
  <Card
    title="Swift"
    description="Swift Package Manager — iOS 15+, macOS 12+, tvOS, watchOS"
...
- [Concepts](/docs/concepts/two-modes) — understand modes, multi-tenancy, errors, events, and webhooks
- [Cookbook](/docs/cookbook) — copy-paste recipes with Python, TypeScript, and Swift tabs
- [SDK reference](/docs/sdks/python) — per-language install, public surface, and changelog links
