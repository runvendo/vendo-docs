...
<Callout type="info">
  The canonical machine-readable schema is [`vendo.schema.json`](https://github.com/runvendo/vendo-cli/blob/main/src/lib/vendo.schema.json) in the `vendo-cli` repo. `vendo validate ./vendo.yaml` runs `ajv` against that file. If this page and the JSON Schema disagree, the JSON Schema wins.
</Callout>
